...
│ │ ├── 9.4.1 Backend Documentation Structure
│ │ ├── 9.4.2 Backend Architecture & ML Inference
│ │ ├── 9.4.3 API Contract & Schemas
│ │ ├── 9.4.4 Development & Testing Guide
│ │ ├── 9.4.5 Deployment & Render Strategy
...
│ │ ├── 10.1.6 Navbar
│ │ │ ├── 10.1.6.1 Navbar Architecture & Structure
...
│ │ ├── 10.1.7 Home Page UI
│ │ │ ├── 10.1.7.1 Home & Component Structure
│ │ │ ├── 10.1.7.2 Hero / Intro Content
│ │ │ ├── 10.1.7.3 Prediction CTA Card
